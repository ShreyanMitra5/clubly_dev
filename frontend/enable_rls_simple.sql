-- Simple RLS Enable Script - Fallback Version
-- This script enables RLS with basic policies for immediate production use
-- Use this if the comprehensive version has any issues
