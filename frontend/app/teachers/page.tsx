  ...
  useEffect(() => {
    if (isSignedIn && user) {
      ...
      const checkTeacherStatus = async () => {
        try {
          const response = await fetch('/api/teachers/check-status', {
            method: 'GET',
            headers: {
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 pt-32 pb-20">
        ...
        >
          ...
          >
            ...
            <span className="text-sm font-extralight text-gray-700">Teacher Access</span>
          </motion.div>
          
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extralight text-gray-900 mb-4 leading-tight">
            Join Clubly as a
            <br />
            <span className="text-orange-500 font-light">Teacher Advisor</span>
          </h1>
          
          <p className="text-xl text-gray-600 font-extralight max-w-2xl mx-auto leading-relaxed">
            Help guide student clubs and organizations. Share your expertise and mentor the next generation of leaders.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-light text-gray-900">Mentor Students</h3>
            </div>
            <p className="text-gray-600 font-extralight leading-relaxed">
              Guide student clubs with your expertise and help them achieve their goals.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-light text-gray-900">Flexible Schedule</h3>
            </div>
            <p className="text-gray-600 font-extralight leading-relaxed">
              Set your availability and meet with students on your own schedule.
            </p>
          </motion.div>
          ...
          >
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-light text-gray-900">School Integration</h3>
            </div>
            <p className="text-gray-600 font-extralight leading-relaxed">
              Connect with students from your school district and build meaningful relationships.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="bg-white/80 backdrop-blur-xl border border-gray-200/50 rounded-2xl p-8 mb-8">
            ...
            <p className="text-gray-600 font-extralight mb-6 max-w-md mx-auto">
              Join thousands of teachers who are already mentoring student clubs and organizations.
            </p>
