...
import { useAuth, UserButton, SignInButton, SignUpButton, SignOutButton } from '@clerk/nextjs';
  ...
  if (!isLoaded) {
    return (
      <header className="fixed top-0 left-0 right-0 z-50 px-4 pt-4">
        <nav className="mx-auto max-w-7xl transition-all duration-700 ease-out bg-white/40 backdrop-blur-xl border border-black/5 shadow-xl shadow-black/5 rounded-2xl px-8 py-4 relative overflow-hidden">
