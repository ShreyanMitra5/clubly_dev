...
// If you have a LottieAnimation component, import it, else comment out
        ...
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-24 items-center justify-center">
          <div className="w-full lg:w-1/2">
            <div className="max-w-2xl text-left">
              ...
              >
                Clubly: Where AI<br className="hidden sm:inline" />Meets Leadership
              </h1>
              <p 
                style={{ animationDelay: "0.5s" }} 
                className="section-subtitle mt-3 sm:mt-6 mb-4 sm:mb-8 leading-relaxed opacity-0 animate-fade-in text-gray-950 font-normal text-base sm:text-lg text-left"
              >
                We know how much work goes into running a great club. That's why we built Clubly - to handle the boring stuff so you can focus on what really matters.
              </p>
              <div 
          ...
          <div className="w-full lg:w-1/2 relative mt-6 lg:mt-0">
            {/* Uncomment if you have LottieAnimation */}
            {/* {lottieData ? (
