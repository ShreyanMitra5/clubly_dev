...
const LandingNewsletter = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API call
    setTimeout(() => {
      toast.success("Thank you for subscribing! You'll receive updates about Clubly soon.");
      setEmail("");
  ...
  return <section id="newsletter" className="bg-white py-0">
      <div className="section-container">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Stay connected with Clubly</h2>
          <p className="text-xl text-gray-700 mb-10 text-left">
            Get the latest updates, tips that actually work, and cool ideas for making your club awesome
          </p>
